        ...
        <div class="flex items-center justify-center h-screen">
            <div class="w-full max-w-lg p-8 bg-white rounded-md shadow-md">
                ...
                <div class="my-8 flex items-center space-x-4">
                    <button
                        class="w-1/2 flex items-center dark--text px-4 py-2 rounded-md border border-gray-200 bg-white hover:bg-gray-100">
                ...
                <div class="flex items-center justify-between">
                    <span class="w-1/2 border-b dark:border-dark-primary"></span>
